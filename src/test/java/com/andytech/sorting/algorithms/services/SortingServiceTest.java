...
public class SortingServiceTest {
    ...
    public void sortingNullTest() {
        ...
        assert(sortingService.quickSort(null, null, false) != null);
    }
    ...
    public void sortingAscTest() {
        ...
        assert(sortingService.quickSort(new ArrayList<>(Arrays.asList(5,7,6,11,1)), "asc", false).getSorted().toString().equals("[1, 5, 6, 7, 11]"));
    }
    ...
    public void sortingDescTest() {
        ...
        assert(sortingService.quickSort(new ArrayList<>(Arrays.asList(5,7,6,11,1)), "desc", false).getSorted().toString().equals("[11, 7, 6, 5, 1]"));
    }
    ...
    public void sortingStepsTest() {
        ...
        assert(sortingService.quickSort(new ArrayList<>(Arrays.asList(5,7,6,11,1)), "asc", true).getSteps().size() > 0);
    }
    ...
    public void sortingStepsNullTest() {
        ...
        assert(sortingService.quickSort(new ArrayList<>(Arrays.asList(5,7,6,11,1)), "asc", false).getSteps() == null);
    }
